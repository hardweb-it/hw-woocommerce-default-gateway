=== Default Gateway for WooCommerce===
Tags: woocommerce, default, gateway, payment, method, woo, paypal
...
* Go to WooCommerce Payment section and select which you want as default.
* That's all! Enjoy.
